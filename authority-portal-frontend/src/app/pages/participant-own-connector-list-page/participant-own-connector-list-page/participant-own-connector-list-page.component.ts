  ...
  implements OnInit, OnDestroy
{
  ...
  initializeHeaderBar() {
    this.headerConfig = {
      title: this.translate.instant('PAGES.CONNECTORS.OWN_TITLE'),
      subtitle: this.translate.instant('PAGES.CONNECTORS.OWN_SUBTITLE'),
      headerActions: [
        {
          label: this.translate.instant('PAGES.CONNECTORS.ADD_CONNECTOR'),
          action: () =>
  ...
  private updateTitle(): void {
    this.titleService.setTitle(
      this.translate.instant('PAGES.CONNECTORS.OWN_TITLE'),
    );
  }
  ...
  private startListeningToState() {
    this.store
      .select<ParticipantOwnConnectorListPageState>(
        (state) =>
          state.ParticipantOwnConnectorListPageState as ParticipantOwnConnectorListPageState,
      )
      .pipe(takeUntil(this.ngOnDestroy$))
      .subscribe((state) => {
        this.state = state;
